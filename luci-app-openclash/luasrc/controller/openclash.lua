...
function index()
	...
	entry({"admin", "services", "openclash", "client"},form("openclash/client"),_("Ringkasan"), 20).leaf = true
	entry({"admin", "services", "openclash", "yacd"},template("openclash/yacd"),_("Panel Yacd"), 23).leaf = true
	...
	entry({"admin", "services", "openclash", "config-overwrite"},cbi("openclash/config-overwrite"),_("Tulis Ulang Pengaturan"), 40).leaf = true
	...
	entry({"admin", "services", "openclash", "pengaturan-penyedia-rule"},cbi("openclash/pengaturan-penyedia-rule"),_("Tambahkan Penyedia Rule"), 60).leaf = true
	...
	entry({"admin", "services", "openclash", "oceditor"},template("openclash/oceditor"),_("Edit Konfig"), 90).leaf = true
	entry({"admin", "services", "openclash", "log"},cbi("openclash/log"),_("Log OC"), 110).leaf = true
